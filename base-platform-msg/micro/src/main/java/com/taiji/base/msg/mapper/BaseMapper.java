...
public interface BaseMapper<ENTITY,VO> {
    ...
    default List<ENTITY> voListToEntityList(List<VO> voList,@Context CycleAvoidingMappingContext context)
    {
        if ( voList == null) {
            return null;
        }
    ...
    default RestPageImpl<VO> entityPageToVoPage(Page<ENTITY> entityPage, Pageable page,@Context CycleAvoidingMappingContext context)
    {
