...
@SelectBeforeUpdate
@Entity
@Table(name = "ED_DAILYLOG")
public class DailyLog extends BaseEntity<String> implements DelFlag {
    ...
    @Getter
    @Setter
    @OneToMany(fetch = FetchType.LAZY,mappedBy = "dailyLog",targetEntity = DailyLogTreatment.class)
    private List<DailyLogTreatment> dLogTreatment;
